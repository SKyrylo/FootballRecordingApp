...
class BallTracksDrawer:
    ...
    """
    def __init__(self):
        self.ball_bbox_color = (255, 255, 153)
    
    def draw(self, video_frames, tracks):
        """
        Draws ball bboxes on each video frame based on provided tracking information.
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for _, ball in ball_dict.items():
                if ball["bbox"] is None:
                    continue
                frame = draw_bbox(frame, ball["bbox"],self.ball_pointer_color)
