...
class TeamAssigner:
    ...
    def __init__(self,
                 ...
                 team_2_class_name= "orange shirt",
                 ):
        """
    ...
    def get_player_color(self,frame,bbox):
        ...
        """
        # Assuming bbox is in YOLO format [center_x, center_y, width, height] (normalized)
        h, w, _ = frame.shape  # Get the image height and width

        # Convert YOLO bounding box (normalized) to pixel coordinates
